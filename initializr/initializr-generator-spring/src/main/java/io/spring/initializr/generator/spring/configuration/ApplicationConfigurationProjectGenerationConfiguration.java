...
public class ApplicationConfigurationProjectGenerationConfiguration {
	...
	@Bean
	public DeployConfigContributor puppetConfigContributor(
		...
		return new DeployConfigContributor(resolvedProjectDescription,
				mustacheTemplateRenderer, initializrMetadata);
	}
