...
public class InitializrProperties extends InitializrConfiguration {
	...
	/**
	 * Available deploy configurationas.
	 */
	@JsonIgnore
	private final List<DefaultMetadataElement> deploys = new ArrayList<>();
	 ...
	 */
	@JsonIgnore
	private final SimpleElement groupId = new SimpleElement("no.difi");
	 ...
	 */
	@JsonIgnore
	private final SimpleElement version = new SimpleElement("DEV-SNAPSHOT");

	/**
	 * Name metadata.
	 */
	@JsonIgnore
	private final SimpleElement name = new SimpleElement("ny-app");
	...
	private final SimpleElement description = new SimpleElement(
			"Eit Spring Boot prosjekt");

	/**
	 * Description metadata.
	 */
	@JsonIgnore
	private final SimpleElement repository = new SimpleElement("github.com:difi");
	...
	public List<DefaultMetadataElement> getDeploys() {
		return this.deploys;
	}
	...
	public SimpleElement getRepository() {
